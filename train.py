"""Training entrypoint copied from previous `main.py` behavior.

Run with:

    python train.py

This file preserves the original training logic so `main.py` can be a web entrypoint
without changing the project's training capabilities.
"""
import glob
import os
